									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
											...
											<tr>
												...
												<td id="idTd" class="hidden-xs"><?php echo $row['fullname'];?></td>
												<td id="idTd"><?php echo $row['address'];?></td>
												<td id="idTd"><?php echo $row['city'];?>
												</td>
												<td id="idTd"><?php echo $row['gender'];?></td>
												<td id="idTd"><?php echo $row['email'];?></td>
												<td id="idTd"><?php echo $row['regDate'];?></td>
												<td id="idTd" >
