								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-file-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle"> Test</h2>
											
											<p class="links cl-effect-1">
												<a href="book-appointment.php">
													<a href="test-list.php">
												<?php $sql= mysqli_query($con,"SELECT * FROM tests WHERE status=1");
													$num_rows2 = mysqli_num_rows($sql);
													{
													?>
													Total Tests(Active) :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
