    ...
    <section class="team-area section_gap">
        <div class="container">
            <div class="row justify-content-center section-title-wrap">
                <div class="col-lg-12">
                    <h1>List Of Tests That We Are Providing</h1>
                    <p>
            ...
            <?php 
                $query_test = $db->prepare('SELECT * FROM tests WHERE status=:status ORDER BY ID DESC');
                $query_test->execute(array('status' => 1));
                foreach($query_test as $test_data){
                    #code...
                    ?>

                    <div class="col-lg-12 col-md-12 single-team mb-50">
                        <h4><i class="lnr lnr-arrow-right"></i> <?php echo $test_data['test_name']; ?>:</h4>
                        <div class="thumb">
                            <img class="object_fit" height="250px" src="../management/uploads/test/<?php echo $test_data['image']; ?>" alt="">
                            <div class="align-items-end justify-content-center d-flex">
                                ...
                                <p>
                                    <a href="single_test.php?test_id=<?php echo $test_data['ID']; ?>" class="aLink">Book now <i class="lnr lnr-arrow-right"></i></a>
                                </p>
                                <p>
                                <h4>Test Fee: <?php echo $test_data['test_fee']; ?>RWF</h4>
                            </div>
                        </div>
                    </div>
